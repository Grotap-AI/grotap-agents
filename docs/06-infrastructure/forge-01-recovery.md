...
| Allowed sources | agent-02-claude `5.161.74.39`, agent-03-claude `5.161.81.193`, agent-04-claude `178.156.222.220`, agent-05-claude `5.161.73.195`, agent-06-claude `5.161.53.103` (Ashburn; Hillsboro `5.78.178.81` is stale — drop it from allowlists), owner workstation `98.97.42.234` |
