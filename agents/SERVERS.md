...
| GEX44 GPU box (llm-gpu-01) | 46.4.91.41 | **Primary Lane C GPU engine** — RTX 4000 SFF Ada 20GB, Hetzner Robot, live 2026-07-09. Ubuntu 24.04 RAID1, ⚠ GRUB pinned to kernel `6.8.0-124-generic` via `GRUB_DEFAULT=saved` (6.8.0-134 hangs on boot — do NOT unpin without console access). NVIDIA 595.71.05/CUDA 13.2. Ollama loopback :11434 (`gpt-oss:20b`, `gemma4:26b`, `gemma4:31b`, `ornith:9b`), Caddy TLS + bearer (`GEX44_LLM_BEARER` in Doppler) at `https://llm-gpu.grotap.com`. Root SSH = fleet key. |
